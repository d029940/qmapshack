...
# CMAKE_PAR="-DQT_DEV_PATH:PATH=$QT_DIR -DLOCAL_DEV:PATH=$LOCAL_ENV -DCMAKE_MACOSX_RPATH=ON -DCMAKE_OSX_DEPLOYMENT_TARGET=$OSX_DEPLOYMENT_TARGET -DCMAKE_VERBOSE_MAKEFILE:BOOL=ON -DGDAL_CONFIG=$LOCAL_ENV/bin/gdal-config -DGDAL_INCLUDE_DIR=$LOCAL_ENV/include -DGDAL_LIBRARY=$LOCAL_ENV/lib/libgdal.dylib"
CMAKE_PAR="-DLOCAL_DEV:PATH=$LOCAL_ENV -DCMAKE_MACOSX_RPATH=ON -DCMAKE_OSX_DEPLOYMENT_TARGET=$OSX_DEPLOYMENT_TARGET -DCMAKE_VERBOSE_MAKEFILE:BOOL=ON -DGDAL_CONFIG=$LOCAL_ENV/bin/gdal-config -DGDAL_INCLUDE_DIR=$LOCAL_ENV/include -DGDAL_LIBRARY=$LOCAL_ENV/lib/libgdal.dylib"
